...
| [HOMEWORK 4](module10/module_10_4.py) | Очереди для обмена данными между потоками.                                |
| [HOMEWORK 5](module10/module_10_5.py) | Многопроцессное программирование. Разница м/у линейнм и многопроцессорным |
| [Practice](module10/Practice.py)      | Многопроцессное программирование. Практика                                |

### <a id="title12">Модуль 11</a>
...
### <a id="title15">Модуль 14</a>

| Homeworks                             | Description                                         |
|---------------------------------------|-----------------------------------------------------|
| [HOMEWORK 1](module14/module_14_1.py) | Создание БД, добавление, выбор и удаление элементов |
